...
The file is not generated by the codebase, but the approved default model is
tracked in Git so a fresh clone is runnable. Its exact source, license, and
checksum are documented in [`../models/README.md`](../models/README.md).
